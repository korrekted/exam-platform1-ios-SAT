...
final class GlobalDefinitions {
    ...
    static let apiKey = "udgKkp1cMgglBQXm"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "Dk7zPgVXymInFKq5"

    static let applicationTag = "EXAM_SAT"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/sat-exam-prep-and-practice/id1565837095"
    static let appleAppID = "1565837095"
